...
namespace ASP_Foods2.Controllers
{
    public class CartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClientId,ProductId,Quantity,DateAdded")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClientId,ProductId,Quantity,DateAdded")] Cart cart)
        {
            if (id != cart.Id)
            {
                return NotFound();
